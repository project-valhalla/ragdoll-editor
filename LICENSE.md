# Preamble
The source code of this ragdoll editor is based on the source code of the Cube Engine 2.
You may use the source code if you abide by the zlib license: http://www.opensource.org/licenses/zlib-license.php

# License
```
Cube 2: Sauerbraten game engine source code, any release.

Copyright (C) 2001-2023 Wouter van Oortmerssen, Lee Salzman, Mike Dysart, Robert Pointon, and Quinton Reeves
